        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://www.instagram.com/__tabuloo__official__?igsh=MTBoY3oxN3pvdDIxZg==" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
           ...
           <div>
             ...
             <ul className="space-y-2">
               ...
               <li>
                 <button 
                   onClick={() => handleQuickLinkClick('/contact-us')}
                   className="text-gray-300 hover:text-white transition-colors text-left w-full"
                 >
                   Contact Us
                 </button>
               ...
               <li>
                 <button 
                   onClick={() => handleQuickLinkClick('/refund-policy')}
                   className="text-gray-300 hover:text-white transition-colors text-left w-full"
                 >
                   Refund Policy
                 </button>
            ...
            <div className="flex items-center">
              ...
              <div>
               ...
               <div>
                 ...
                 <p className="text-gray-300">+91 9100933477</p>
               </div>
             </div>
          </div>
        </div>
