    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-900">Order Food</h2>
        ...
        {step === 'restaurants' && (
          <div className="p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Available Restaurants, Hotels & Food Places</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {availableRestaurants.map((restaurant) => (
                  <div
                    ...
                    className="border rounded-xl p-4 hover:shadow-lg transition-shadow cursor-pointer group"
                  >
                    {restaurant.images[0] && (
                      <img
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-600 capitalize">{restaurant.type}</p>
                      <p className="text-sm text-gray-600">{restaurant.address}</p>
                      <p className="text-sm text-gray-500">{restaurant.timings}</p>
        ...
        {step === 'checkout' && (
          <div className="p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Choose Order Type</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              >
                <div className="text-center">
                  <ShoppingCart className="h-12 w-12 text-blue-600 mx-auto mb-4 group-hover:scale-110 transition-transform" />
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Self Pickup</h4>
                  <p className="text-gray-600">Pick up your order from the restaurant</p>
                  <p className="text-sm text-green-600 mt-2">No delivery charges</p>
                </div>
              </button>
              ...
              >
                <div className="text-center">
                  <Truck className="h-12 w-12 text-green-600 mx-auto mb-4 group-hover:scale-110 transition-transform" />
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Home Delivery</h4>
                  <p className="text-gray-600">Get it delivered to your doorstep</p>
                  <p className="text-sm text-orange-600 mt-2">Delivery charges may apply</p>
                </div>
              </button>
            </div>
          ...
          <div className="p-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                ...
                <p>Items: {cart.reduce((sum, item) => sum + item.quantity, 0)}</p>
                <p className="font-medium text-gray-900 text-base">Total: ₹{getCartTotal().toFixed(2)}</p>
              </div>
            </div>
            ...
            {paymentMethod === 'cod' && (
              <div className="bg-orange-50 p-4 rounded-lg mb-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-orange-900">Cash on Delivery</p>
        ...
        {step === 'confirmation' && (
          <div className="p-6 text-center">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={onClose}
                className="w-full text-gray-600 py-3 px-4 rounded-lg hover:bg-gray-50 font-medium"
              >
                Close
              </button>
            </div>
